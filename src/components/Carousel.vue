...
<template>
    <div id="case-study-carousel" class="carousel slide" data-bs-interval="false" data-bs-ride="true">
        <div class="carousel-indicators">
            <button type="button" data-bs-target="#case-study-carousel" data-bs-slide-to="0" class="active"
            ...
            <button type="button" data-bs-target="#case-study-carousel" data-bs-slide-to="10"
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="../assets/images/casestudyframes/habitfract1/8.png" class="d-block w-100"
